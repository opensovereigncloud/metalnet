...
func (in *NetworkSpec) DeepCopyInto(out *NetworkSpec) {
	*out = *in
	...
	if in.PeeredPrefixes != nil {
		...
		*out = make([]PeeredPrefixes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PeeredPrefixes) DeepCopyInto(out *PeeredPrefixes) {
	*out = *in
	if in.Prefixes != nil {
		in, out := &in.Prefixes, &out.Prefixes
		*out = make([]IPPrefix, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PeeredPrefixes.
func (in *PeeredPrefixes) DeepCopy() *PeeredPrefixes {
	if in == nil {
		return nil
	}
	out := new(PeeredPrefixes)
	in.DeepCopyInto(out)
	return out
}
