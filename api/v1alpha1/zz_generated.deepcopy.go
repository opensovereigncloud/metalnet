...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LBPrefix) DeepCopyInto(out *LBPrefix) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LBPrefix.
func (in *LBPrefix) DeepCopy() *LBPrefix {
	if in == nil {
		return nil
	}
	out := new(LBPrefix)
